...
# csv.loc[csv['피해면적_합계'] < 0.3, '피해면적'] =1
# csv.loc[csv['피해면적_합계'] >= 0.3, '피해면적'] =2
csv.loc[csv['피해면적_합계'] < 0.1,'피해면적'] =1
csv.loc[csv['피해면적_합계'] >= 0.19, '피해면적'] =2
csv.loc[csv['피해면적_합계'] >= 0.2, '피해면적'] =3
csv.loc[csv['피해면적_합계'] >= 0.3, '피해면적'] =4
csv.loc[csv['피해면적_합계'] >= 0.5, '피해면적'] =5
csv.loc[csv['피해면적_합계'] >= 0.6, '피해면적'] =6
csv.loc[csv['피해면적_합계'] >= 1, '피해면적'] =7
csv.loc[csv['피해면적_합계'] >= 2, '피해면적'] =8
